...
console.log(`We now have: ${topicEventManager.listenerCount('subscribe')} listener(s) for the topic subscription event`);

console.log(`We now have: ${topicEventManager.listenerCount('publish')} listener(s) for the topic publishing event`);

pub.listen(port, () => console.log(`Publisher server running on port ${port}!`));